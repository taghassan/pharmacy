...
<html lang="{{ app()->getLocale() }}">
                ...
                <div class="modal-content" >
                  ...
                  <div class="modal-body">
                        ...
                        <div class="card" style="opacity: 0.9;">
                                <div class="card-header " ><h3 class="text-center">تعديل بيانات صيدلية</h3></div>

                                <div class="card-body">


                                    <form action="/Pharmacy/{{ $data->id }}/update" method="post">
                                        <div class="row">
                                            <div class="col-md-6">
    ...
    <div class="col-md-6">
                                                ...
                                                <input  dir="rtl" type="text" name="name" value="{{ $data->name }}" class="form-control"  placeholder="أسم الصيدلية" required>
                                                <label for="" class="col-md-4 control-label"></label>

                                                <textarea  dir="rtl" type="text" name="disc" value="" class="form-control"  placeholder="الوصف" required>{{ $data->disc }}</textarea>
                                                <label for="" class="col-md-4 control-label"></label>
                                                <input  dir="rtl" type="text" name="phone_no" value="{{ $data->phone_no }}" class="form-control"  placeholder="رقم التتواصل  " required><br>
                                              <input type="hidden" name="lon" id="longtitute" value="{{ $data->lon }}">
                                              <input type="hidden" name="lat" id="latitute" value="{{ $data->lat }}">
    </div>
                                    </div>
                                </div>

                                                <center>
                        <button type="submit"  id="save" class="btn btn-success">حفظ</button>
                                                </center>
                                                            </form>
                            </div>
